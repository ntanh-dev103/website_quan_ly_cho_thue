...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 cursor-pointer active:scale-[0.98]',
  {
    variants: {
      variant: {
        default:
          'bg-primary-600 text-white shadow-md shadow-primary-600/20 hover:bg-primary-700 hover:shadow-lg hover:shadow-primary-600/30',
        secondary:
          'bg-secondary-500 text-white shadow-md shadow-secondary-500/20 hover:bg-secondary-600 hover:shadow-lg',
        destructive:
          'bg-destructive-500 text-white shadow-md shadow-destructive-500/20 hover:bg-destructive-600 hover:shadow-lg',
        outline:
        ...
        accent:
          'bg-accent-500 text-white shadow-md shadow-accent-500/20 hover:bg-accent-600 hover:shadow-lg',
      },
      size: {
